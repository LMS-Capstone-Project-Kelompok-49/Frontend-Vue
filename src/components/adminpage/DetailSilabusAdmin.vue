...
<script>
import TabsMaterial from '@/components/adminpage/TabsMaterialAdmin.vue'
import TabsAssignment from '@/components/adminpage/TabsAssignmentAdmin.vue'

export default {
    name: 'DetailSilabusAdmin',
    components: {
        TabsMaterial,
        TabsAssignment,
    },
